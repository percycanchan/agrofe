 ...
 */
    ...
    public afip.facturaElectronica.handshake.wsfe.ServiceSoap_PortType getServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            afip.facturaElectronica.handshake.wsfe.ServiceSoap_BindingStub _stub = new afip.facturaElectronica.handshake.wsfe.ServiceSoap_BindingStub(portAddress, this);
    ...
    private java.lang.String ServiceSoap12_address = "https://wswhomo.afip.gov.ar/wsfe/service.asmx";
    ...
    public afip.facturaElectronica.handshake.wsfe.ServiceSoap_PortType getServiceSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            afip.facturaElectronica.handshake.wsfe.ServiceSoap12Stub _stub = new afip.facturaElectronica.handshake.wsfe.ServiceSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (afip.facturaElectronica.handshake.wsfe.ServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                afip.facturaElectronica.handshake.wsfe.ServiceSoap_BindingStub _stub = new afip.facturaElectronica.handshake.wsfe.ServiceSoap_BindingStub(new java.net.URL(ServiceSoap_address), this);
                _stub.setPortName(getServiceSoapWSDDServiceName());
                return _stub;
            }
            if (afip.facturaElectronica.handshake.wsfe.ServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                afip.facturaElectronica.handshake.wsfe.ServiceSoap12Stub _stub = new afip.facturaElectronica.handshake.wsfe.ServiceSoap12Stub(new java.net.URL(ServiceSoap12_address), this);
                _stub.setPortName(getServiceSoap12WSDDServiceName());
                return _stub;
            }
        }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://ar.gov.afip.dif.facturaelectronica/", "ServiceSoap12"));
        }
