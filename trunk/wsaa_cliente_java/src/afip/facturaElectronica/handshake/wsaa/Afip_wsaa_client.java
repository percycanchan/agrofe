...
public class Afip_wsaa_client {
		...
		public static byte [] create_cms (String p12file, String p12pass, String signer, String dstDN, String service, Long TicketTime) {
			...
			try {
				...
				//Busco el último alias que agregué
				...
				pKey = (PrivateKey)ks.getKey(alias, p12pass.toCharArray());//(signer, p12pass.toCharArray());
				pCertificate = (X509Certificate)ks.getCertificate(alias);//(signer);
