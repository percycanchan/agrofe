...
public class ServiceSoap12Skeleton implements afip.facturaElectronica.handshake.wsfe.ServiceSoap_PortType, org.apache.axis.wsdl.Skeleton {
    ...
    */
    ...
    public ServiceSoap12Skeleton() {
        this.impl = new afip.facturaElectronica.handshake.wsfe.ServiceSoap12Impl();
    }

    public ServiceSoap12Skeleton(afip.facturaElectronica.handshake.wsfe.ServiceSoap_PortType impl) {
        this.impl = impl;
    }
